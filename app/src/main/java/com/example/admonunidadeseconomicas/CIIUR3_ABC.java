...
public class CIIUR3_ABC extends ActionBarActivity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ciiur3__abc);
		
		menu = (ListView) findViewById(R.id.menuCIIUR3);
		headerText = (TextView) findViewById(R.id.headerCIIUR3);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ciiur3__abc, menu);
		return true;
	}
