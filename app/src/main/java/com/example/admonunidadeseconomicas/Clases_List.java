...
public class Clases_List extends ActionBarActivity implements
		OnItemClickListener {
	...
	ArrayList<Map<String, String>> listadoclases = new ArrayList<Map<String, String>>();
	ArrayList<Map<String, String>> listaElementos;
	ArrayList<Map<String, String>> listaClases = new ArrayList<Map<String, String>>();
	...
	String Nombre, Codigo, scianID, Actualizacion, mensaje = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_clases__list);
	...
	public void sigAltas(){
		i = new Intent(this,Clases_Altas.class);
		Bundle b = new Bundle();
	...
	public void sigCambios(Clase clase) {
		i = new Intent(this, Clases_Cambios.class);
		...
		bundleUsuario.putInt("ScianID", clase.getScianID());
		System.out.println("Soy el scian id en la lista: " + clase.ScianID);
		bundleUsuario.putInt("SubRamaID", clase.getSubRamaID());
		bundleUsuario.putString("Codigo", clase.getCodigo());
		bundleUsuario.putString("Nombre", clase.getNombre());
	...
	public void sigBorrar(Clase clase) {
		try{
			
			Borrado borrar = new Borrado();
			borrar.setClase(clase.getScianID());
			borrar.execute();
	...
	public void populateView(){
		sectores = (Spinner)findViewById(R.id.sectoresSpinClase);
		subsectores = (Spinner)findViewById(R.id.subsectoresSpinClase);
		ramas = (Spinner)findViewById(R.id.ramasSpinClase);
		subramas = (Spinner)findViewById(R.id.subRamasSpinClase);
		listaclases = (ListView) findViewById(R.id.ClasesListado);
		headerText = (TextView) findViewById(R.id.headerClasesList);
	}
	...
	// region CLASE PARA LISTAR ASYNCRONAMENTE
		class listarClases extends
			...
			InputStream is;
			Clase[] ClaseNormal;
			ArrayList<Map<String, String>> listaClases2 = new ArrayList<Map<String, String>> ();
			ArrayList<Map<String, String>>  listaClases = new ArrayList<Map<String, String>> ();

			public void setClasesList(ArrayList<Map<String, String>> listaClase) {
			...
			protected SimpleAdapter doInBackground(ListView... params) {
				...
				if(!resultado.equals("null")){
					...
					mensaje = "La subrama no tiene clases vinculadas";

				SimpleAdapter adaptador = new SimpleAdapter(contexto, listaClases, 
	...
	//region CLASE QUE IMPLEMENTA ASYNCTASK
  	class Borrado extends AsyncTask<Void, Void, Void> {
		...
		Clase thisClase = new Clase();
		String Respuesta = null,Nombre=null,Codigo=null;;
		int ID = 0;
		
	
		public void setClase(int ID){
			this.ID = ID;
			thisClase.ScianID = ID;
		}
	
		@Override
		protected void onPreExecute() {

           progreso = new ProgressDialog(Clases_List.this);
		...
		protected Void doInBackground(Void... array) {
			thisClase.delete(thisClase.ScianID);
			return null;
		}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (!parent.getAdapter().isEmpty()){
			...
			Map<String, String>  claseLister = new HashMap<String, String>(2);
			clase = new Clase();
			claseLister  =  (Map<String, String>) parent.getAdapter().getItem(position);
			
			clase.setScianID(Integer.parseInt(claseLister.get("ScianID")));
			clase.setCodigo(claseLister.get("Codigo").toString());
			clase.setNombre(claseLister.get("Nombre").toString());
			clase.setSubRamaID(Integer.parseInt(claseLister.get("SubRamaID")));
