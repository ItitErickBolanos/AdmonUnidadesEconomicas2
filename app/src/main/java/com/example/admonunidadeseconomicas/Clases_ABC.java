...
public class Clases_ABC extends ActionBarActivity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_clases__abc);
		
		menu = (ListView) findViewById(R.id.menuClases);
		headerText = (TextView) findViewById(R.id.headerClases);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.clases__abc, menu);
		return true;
	}
