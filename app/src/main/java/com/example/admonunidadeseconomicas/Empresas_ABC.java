...
public class Empresas_ABC extends ActionBarActivity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_empresas__abc);
		
		menu = (ListView) findViewById(R.id.menuEmpresas);
		headerText = (TextView) findViewById(R.id.headerEmpresas);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.empresas__abc, menu);
		return true;
	}
