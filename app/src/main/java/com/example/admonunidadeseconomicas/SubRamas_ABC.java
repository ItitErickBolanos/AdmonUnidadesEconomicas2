...
public class SubRamas_ABC extends ActionBarActivity implements OnItemClickListener{
...
//region METODOS NATIVOS DE LA CLASE
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sub_ramas__abc);
		
		menu = (ListView) findViewById(R.id.menuSubRamas);
		headerText = (TextView) findViewById(R.id.headerSubRamas);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sub_ramas__abc, menu);
		return true;
	}
