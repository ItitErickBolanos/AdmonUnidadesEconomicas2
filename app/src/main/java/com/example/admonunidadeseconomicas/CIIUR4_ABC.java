...
public class CIIUR4_ABC extends ActionBarActivity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ciiur4__abc);
		
		menu = (ListView) findViewById(R.id.menuCIIUR4);
		headerText = (TextView) findViewById(R.id.headerCIIUR4);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ciiur4__abc, menu);
		return true;
	}
