...
public class CiiuRev3_List extends ActionBarActivity implements
		OnItemClickListener {
	...
	TextView headerText;
	ListView listaciiurev3;
	ArrayList<Map<String, String>> listadociiurev3 = new ArrayList<Map<String, String>>();
	ArrayList<Map<String, String>> listaElementos;
	ArrayList<Map<String, String>> listaCiiurev3 = new ArrayList<Map<String, String>>();
	...
	String Nombre, Codigo, ciiurev3ID, Actualizacion, mensaje = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ciiu_rev3__list);
		...
		listaciiurev3.setOnItemClickListener(this);
	}
	...
	public void sigAltas(){
		i = new Intent(this,CiiuRev3_Altas.class);
		Bundle b = new Bundle();
	...
	public void sigCambios(CIIURev3 ciiurev3) {
		i = new Intent(this, CiiuRev3_Cambios.class);
		...
		bundleUsuario.putInt("CiiuRev3ID", ciiurev3.getCiiuRev4ID());
		System.out.println("Soy el ciiurev3 id en la lista: " + ciiurev3.CiiuRev3ID);
		bundleUsuario.putInt("CiiuRev3ID", ciiurev3.getCiiuRev3ID());
		bundleUsuario.putString("Codigo", ciiurev3.getCodigo());
		bundleUsuario.putString("Nombre", ciiurev3.getNombre());
		...
		bundleUsuario.putInt("posicionSpinnerCR4", ciiurev4s.getSelectedItemPosition());
	...
	public void sigBorrar(CIIURev3 ciiurev3) {
		try{
			
			Borrado borrar = new Borrado();
			borrar.setCiiuRev3(ciiurev3.getCiiuRev3ID());
			borrar.execute();
	...
	public void populateView(){
		sectores = (Spinner)findViewById(R.id.sectoresSpinCiiuRev3);
		subsectores = (Spinner)findViewById(R.id.subsectoresSpinCiiuRev3);
		ramas = (Spinner)findViewById(R.id.ramasSpinCiiuRev3);
		subramas = (Spinner)findViewById(R.id.subRamasSpinCiiuRev3);
		clases = (Spinner)findViewById(R.id.clasesSpinCiiuRev3);
		ciiurev4s = (Spinner)findViewById(R.id.ciiuRev4SpinCiiuRev3);
		listaciiurev3 = (ListView) findViewById(R.id.CiiuRev3Listado);
		headerText = (TextView) findViewById(R.id.headerCiiuRev3List);
	}
	...
	// region CLASE PARA LISTAR ASYNCRONAMENTE
						    ...
						    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
						    	if (!parentView.getAdapter().isEmpty()){
									...
									try{
										...
										CiiuRev3.execute(listaciiurev3);
									}catch(Exception e){
										e.printStackTrace();
									}
								}
		...
		// region CLASE PARA LISTAR ASYNCRONAMENTE
				class listarCiiuRev3 extends
					...
					ArrayList<Map<String, String>> listaCiiuRev32 = new ArrayList<Map<String, String>> ();
					ArrayList<Map<String, String>>  listaCiiuRev3 = new ArrayList<Map<String, String>> ();

					public void setCiiuRev3List(ArrayList<Map<String, String>> listaCiiuRev3) {
					...
					protected SimpleAdapter doInBackground(ListView... params) {
						...
						if(!resultado.equals("null")){
							...
							mensaje = "El CIIU Rev 4 no tiene equivalente CIIU Rev 3";

						SimpleAdapter adaptador = new SimpleAdapter(contexto, listaCiiuRev3, 
	...
	//region CLASE QUE IMPLEMENTA ASYNCTASK
  	class Borrado extends AsyncTask<Void, Void, Void> {
		...
		CIIURev3 thisCiiuRev3 = new CIIURev3();
		String Respuesta = null,Nombre=null,Codigo=null;;
		int ID = 0;
		
	
		public void setCiiuRev3(int ID){
			this.ID = ID;
			thisCiiuRev3.CiiuRev3ID = ID;
		}
	
		@Override
		protected void onPreExecute() {

           progreso = new ProgressDialog(CiiuRev3_List.this);
		...
		protected Void doInBackground(Void... array) {
			thisCiiuRev3.delete(thisCiiuRev3.CiiuRev3ID);
			return null;
		}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (!parent.getAdapter().isEmpty()){
			...
			Map<String, String>  ciiuRev3Lister = new HashMap<String, String>(2);
			ciiurev3 = new CIIURev3();
			ciiuRev3Lister  =  (Map<String, String>) parent.getAdapter().getItem(position);
			
			ciiurev3.setCiiuRev4ID(Integer.parseInt(ciiuRev3Lister.get("CiiuRev4ID")));
			ciiurev3.setCodigo(ciiuRev3Lister.get("Codigo").toString());
			ciiurev3.setNombre(ciiuRev3Lister.get("Nombre").toString());
			ciiurev3.setCiiuRev3ID(Integer.parseInt(ciiuRev3Lister.get("CiiuRev3ID")));
