...
public class CiiuRev2_List extends ActionBarActivity implements
		OnItemClickListener {
	...
	TextView headerText;
	ListView listaciiurev2;
	ArrayList<Map<String, String>> listadociiurev2 = new ArrayList<Map<String, String>>();
	ArrayList<Map<String, String>> listaElementos;
	ArrayList<Map<String, String>> listaCiiurev2 = new ArrayList<Map<String, String>>();
	...
	String Nombre, Codigo, ciiurev2ID, Actualizacion, mensaje = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ciiu_rev2__list);
		...
		listaciiurev2.setOnItemClickListener(this);
	}
	...
	public void sigAltas(){
		i = new Intent(this,CiiuRev2_Altas.class);
		Bundle b = new Bundle();
	...
	public void sigCambios(CIIURev2 ciiurev2) {
		i = new Intent(this, CiiuRev2_Cambios.class);
		...
		bundleUsuario.putInt("CiiuRev2ID", ciiurev2.getCiiuRev2ID());
		System.out.println("Soy el ciiurev2 id en la lista: " + ciiurev2.CiiuRev2ID);
		bundleUsuario.putInt("CiiuRev3ID", ciiurev2.getCiiuRev3ID());
		bundleUsuario.putString("Codigo", ciiurev2.getCodigo());
		bundleUsuario.putString("Nombre", ciiurev2.getNombre());
		...
		bundleUsuario.putInt("posicionSpinnerCiiuRev4", ciiurev4s.getSelectedItemPosition());
		bundleUsuario.putInt("posicionSpinnerCiiuRev3", ciiurev3s.getSelectedItemPosition());
	...
	public void sigBorrar(CIIURev2 ciiurev2) {
		try{
			
			Borrado borrar = new Borrado();
			borrar.setCiiuRev2(ciiurev2.getCiiuRev2ID());
			borrar.execute();
	...
	public void populateView(){
		sectores = (Spinner)findViewById(R.id.sectoresSpinCiiuRev2);
		subsectores = (Spinner)findViewById(R.id.subsectoresSpinCiiuRev2);
		ramas = (Spinner)findViewById(R.id.ramasSpinCiiuRev2);
		subramas = (Spinner)findViewById(R.id.subRamasSpinCiiuRev2);
		clases = (Spinner)findViewById(R.id.clasesSpinCiiuRev2);
		ciiurev4s = (Spinner)findViewById(R.id.ciiuRev4SpinCiiuRev2);
		ciiurev3s = (Spinner)findViewById(R.id.ciiuRev3SpinCiiuRev2);
		listaciiurev2 = (ListView) findViewById(R.id.CiiuRev2Listado);
		headerText = (TextView) findViewById(R.id.headerCiiuRev2List);
	}
	...
	// region CLASE PARA LISTAR ASYNCRONAMENTE
						...
						list.setOnItemSelectedListener(new OnItemSelectedListener() {
						    ...
						    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
						    	if (!parentView.getAdapter().isEmpty()){
									...
									try{
										listarCiiuRev2 CiiuRev2 = new listarCiiuRev2();
										CiiuRev2.cargarContenido(getApplicationContext());
										CiiuRev2.setCiiuRev2List(listadociiurev2);
										CiiuRev2.execute(listaciiurev2);
									}catch(Exception e){
										e.printStackTrace();
									}
								}
		...
		// region CLASE PARA LISTAR ASYNCRONAMENTE
				class listarCiiuRev2 extends
					AsyncTask<ListView, Void, SimpleAdapter> {
					Context contexto;
					ListView list;
					InputStream is;
					CIIURev2[] CIIURev2Normal;
					ArrayList<Map<String, String>> listaCiiuRev22 = new ArrayList<Map<String, String>> ();
					ArrayList<Map<String, String>>  listaCiiuRev2 = new ArrayList<Map<String, String>> ();

					public void setCiiuRev2List(ArrayList<Map<String, String>> listaCiiuRev2) {
						this.listaCiiuRev22 = listaCiiuRev2;
					}
					...
					protected SimpleAdapter doInBackground(ListView... params) {
						...
						list = params[0];
						String resultado = "fallo";
						CIIURev3 enviarCiiuRev3 = (ciiurev3 != null) ? ciiurev3 : objCiiurev3;
						//SectorID = ;
						//SectorList sector;
						...
						HttpClient cliente = new DefaultHttpClient();
						HttpGet peticionGet = new HttpGet(
								"http://semestral.esy.es/ConvertidorUnidades/Fetchs.php?opcion=11&CiiuRev3ID=" + enviarCiiuRev3.CiiuRev3ID);
						...
						if(!resultado.equals("null")){
							...
							mensaje = "El CIIU Rev 3 no tiene equivalente CIIU Rev 2";

						SimpleAdapter adaptador = new SimpleAdapter(contexto, listaCiiuRev2, 
	...
	//region CLASE QUE IMPLEMENTA ASYNCTASK
  	class Borrado extends AsyncTask<Void, Void, Void> {
		...
		CIIURev2 thisCiiuRev2 = new CIIURev2();
		String Respuesta = null,Nombre=null,Codigo=null;;
		int ID = 0;
		
	
		public void setCiiuRev2(int ID){
			this.ID = ID;
			thisCiiuRev2.CiiuRev2ID = ID;
		}
	
		@Override
		protected void onPreExecute() {

           progreso = new ProgressDialog(CiiuRev2_List.this);
           progreso.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
           progreso.setTitle("Eliminando Equivalencia CIIU Rev 3");
           progreso.setMessage("Borrando Equivalencia CIIU Rev 3, Espere...");
		...
		protected Void doInBackground(Void... array) {
			thisCiiuRev2.delete(thisCiiuRev2.CiiuRev2ID);
			return null;
		}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (!parent.getAdapter().isEmpty()){
			...
			Map<String, String>  ciiuRev2Lister = new HashMap<String, String>(2);
			ciiurev2 = new CIIURev2();
			ciiuRev2Lister  =  (Map<String, String>) parent.getAdapter().getItem(position);
			
			ciiurev2.setCiiuRev3ID(Integer.parseInt(ciiuRev2Lister.get("CiiuRev3ID")));
			ciiurev2.setCodigo(ciiuRev2Lister.get("Codigo").toString());
			ciiurev2.setNombre(ciiuRev2Lister.get("Nombre").toString());
			ciiurev2.setCiiuRev2ID(Integer.parseInt(ciiuRev2Lister.get("CiiuRev2ID")));
