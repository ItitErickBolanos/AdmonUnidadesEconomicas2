...
public class Usuarios_ABC extends ActionBarActivity implements OnItemClickListener{
...
//region METODOS NATIVOS DE LA CLASE
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_usuarios__abc);
		
		
		menu = (ListView) findViewById(R.id.menuUsuarios);
		headerText = (TextView) findViewById(R.id.headerUsuarios);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.usuarios__abc, menu);
		return true;
	}
