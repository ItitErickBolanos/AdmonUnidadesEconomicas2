...
public class SubSectores_ABC extends ActionBarActivity implements OnItemClickListener {
...
//region METODOS NATIVOS DE LA CLASE
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sub_sectores__abc);
		
		menu = (ListView) findViewById(R.id.menuSubSectores);
		headerText = (TextView) findViewById(R.id.headerSubSectores);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sub_sectores__abc, menu);
		return true;
	}
