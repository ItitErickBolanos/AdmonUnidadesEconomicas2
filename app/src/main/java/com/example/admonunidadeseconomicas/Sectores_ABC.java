...
public class Sectores_ABC extends ActionBarActivity implements OnItemClickListener{
...
//region METODOS NATIVOS DE LA CLASE
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sectores__abc);
		
		menu = (ListView) findViewById(R.id.menuSectores);
		headerText = (TextView) findViewById(R.id.headerSectores);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sectores__abc, menu);
		return true;
	}
